...
import { IProfile, IProfileCreate } from "../../configuration/api/dto/IProfile";
...
export const Compte = () => {
    ...
    const notify = async () => {
        ...
        if (idToken === null) {
            ...
            try {
                const r:any = await getLongAndLat();

                let newProfile:IProfileCreate = {
                    age: age as number,
                    job: job as string,
                    city: city as string,
                ...
                const resp = await profiles.createProfile(idToken, newProfile);
                ...
                toast("Il faut qu'on te localise 😔");
            }
            ...
            //         }
            //     }
            //     const resp = await profiles.createProfile(idToken as string, {});
            //     // toast("Mise à jour !");
            //     // const resp = await profiles.createProfile
            //     // profiles.createProfile( as string, {
                                ...
                                <div>
                                    <div className="m-2" style={{ "width": "20em" }}>
                                        <div className="card-body text-center">
                                            ...
                                            <ToastContainer />
                                            <button className="btn btn-md btn-primary shadow mt-3 shadow" disabled={hasBeenModified} onClick={notify}>Confirmer</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
